...
//ray - изменение длины бокового левого луча      //ray3 - изменение длины нижнего левого луча         //star1 - вторые лучи
//ray2 - изменение длины нижнего правого луча     //dir - параметр отражения
{
...
//foot - изменение длины ног , от -75 до 0   //dir  - параметр отражения           //foots - изменение ног
//height - изменение высоты                  //windows - изменение иллюминаторов
{
...
//plant - изменение положения листочка по оси x , от 0 до 1      //dir - параметр отражения лево-право     //dir2 - параметр отражения верх-низ
//plant2 - изменение положения листочка по оси y , от 0 до 1     //green - изменение листочка
{
    txSetFillColor(color1);
...
//eyes - изменение глаз , 1 - закрыты , 0 - открыты   //dir - параметр отражения  //kolesa - изменение положения колес по y
//hand - изменение длины руки , от 0 до 1             //circle - изменение колес
{
    txSetFillColor(color1);
...
void draw_eva( int x, int y, double scale, COLORREF color1, int eyes, int had, int dir, int hands, int hands2, int ogonek)
//dir - параметр отражения                    //eyes - изменение глаз        //hands2 - изменение рук по y
//had - изменение положения головы по y       //hands - изменение рук по x   //ogonek - изменение цвета огонька
{
    txSetFillColor(color1);
    txSetColor(color1);
