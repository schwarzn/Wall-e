/*
  ...
  x - X-координата верхнего луча звезды
  y - Y-координата верхнего луча звезды
  scale - маштаб
  color1 - цвет заполнения звезды
  color2 - цвет контура звезды
  ray - изменение длины бокового левого луча
  ray2 - изменение длины нижнего правого луча
  ray3 - изменение длины нижнего левого луча
  dir - параметр отражения
  star1 - вторые лучи
*/
void draw_star( int x, int y, double scale, COLORREF color1, COLORREF color2, int ray        , int ray2    , int dir      , int ray3    , int star1);
/*
  рисует летающую тарелку

  x - X-координата центра нло
  y - Y-координата центра нло
  scale - маштаб
  color1 - цвет корпуса нло
  color2 - цвет доп. деталей нло
  foot - изменение длины ног , от -75 до 0
  height - изменение высоты
  dir  - параметр отражения
  windows - изменение иллюминаторов
  foots - изменение ног
*/
...
/*
  ...
  x - X-координата ботинка
  y - Y-координата ботинка
  scale - маштаб
  color1 - цвет основной части ботинка
  color2 - цвет контура ботинка
  color3 - цвет внутренней части ботинка
  plant - изменение положения листочка по оси x , от 0 до 1
  plant2 - изменение положения листочка по оси y , от 0 до 1
  dir - параметр отражения лево-право
  green - изменение листочка
  dir2 - параметр отражения верх-низ
*/
...
/*
  ...
  y - Y-координата ботинка
  scale - маштаб
  color1 - цвет тела робота
  color2 - цвет головы и гусениц робота
  color3 - цвет лица робота
  eyes - изменение глаз, 1 - закрыты , 0 - открыты
  hand - изменение длины руки, можно ввести 0 или 1
  dir - параметр отражения, 1 - влево, -1 - вправо
  circle - кружки на гусеницах, 1 - рисуются, -1 - не рисуются
  kolesa - изменение положения гусениц по y
*/
...
/*
  ...
  y - Y-координата ботинка
  scale - маштаб
  color1 - цвет тела Евы
  eyes - изменение глаз, 1 - рисуются, -1 - не рисуются
  had - изменение положения головы по y
  dir - параметр отражения, НЕ ИСПОЛЬЗУЙ, ЭТА ШТУКА БЕСПОЛЕЗНА
  hands - изменение рук по x
  hands2 - изменение рук по y
  ogonek - изменение цвета огонька, 1 - зеленый, -1 - белый
*/
